...
typedef __packed struct{//0x0105
	...
	uint16_t dart_info[7];//bit 0-1:默认0 前哨站1 基地固定目标2 基地随机目标3   2-4:累计集中数最高4    5-6:选定击打目标 前哨0 选中1 随机2
}ext_dart_info_t;

typedef __packed struct{//0x020A
	uint8_t dart_launch_opening_stauts;//1关闭 2启动中 0开启
	uint8_t reserved;
...
extern ext_dart_info_t  dart_info_t;
