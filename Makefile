##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.4.0-B60] date: [Fri May 16 19:22:05 CST 2025] 
##########################################################################################################################
...
modules/motor/JZmotor/jz_motor.c \
...
#	openocd -f openocd_dap.cfg -c init -c halt -c "flash write_image erase basic_framework.bin 0x08000000" -c reset -c shutdown
download_jlink:
	JFlash -openprj'stm32.jflash' -open'$(BUILD_DIR)/$(TARGET).hex',0x8000000 -auto -startapp -exit
#	JFlash -openprj'stm32.jflash' -open'basic_framework.hex',0x8000000 -auto -startapp -exit
download_stlink:
