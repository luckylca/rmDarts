...
void referee_data_solve(uint8_t *frame)
{
    ...
    switch (cmd_id)
    {
        ...
        break;
				case DART_DATA_CMD_ID:
				{
					 memcpy(&dart_info_t,frame+index,sizeof(dart_info_t));
				}
				case DART_CMD_ID:
				{
...
ext_dart_client_cmd_t get_dart_client_cmd_t(void)
{
	return dart_client_cmd_t;
}

ext_dart_info_t get_dart_info_t(void)
{
	return dart_info_t;
}
