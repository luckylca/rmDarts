...
//底盘前后左右控制按键
#define CHASSIS_FRONT_KEY KEY_PRESSED_OFFSET_A
#define CHASSIS_BACK_KEY KEY_PRESSED_OFFSET_D
#define CHASSIS_LEFT_KEY KEY_PRESSED_OFFSET_W
#define CHASSIS_RIGHT_KEY KEY_PRESSED_OFFSET_S
//底盘模式按键
#define CHASSIS_ROTATE_KEY                      	  KEY_PRESSED_OFFSET_F
#define CHASSIS_INFANTRY_FOLLOW_GIMBAL_YAW_KEY      KEY_PRESSED_OFFSET_G
#define CHASSIS_NO_FOLLOW_YAW_KEY              		  KEY_PRESSED_OFFSET_C
...
typedef enum
{
  ...
  CHASSIS_VECTOR_RAW,									// control-current will be sent to CAN bus derectly.
	CHASSIS_VECTOR_ROTATE,							//啥玩意？
	CHASSIS_VECTOR_DOUBLE_SHOOT					// 飞镖双电机配置
